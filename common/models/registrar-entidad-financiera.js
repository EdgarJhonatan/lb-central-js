...
module.exports = function (registrarEntidadFinanciera) {
  registrarEntidadFinanciera.registrarEntidadFinancieraPost = function (
    data,
    cb
  ) {
    let bodyJson;
    ...
    function consultaBD(query) {
      return new Promise(function (resolve, reject) {
        ...
        const db = registrarEntidadFinanciera.dataSource;
