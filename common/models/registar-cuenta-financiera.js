...
module.exports = function (registarCuentaFinanciera) {
  registarCuentaFinanciera.registarCuentaFinancieraPost = function (data, cb) {
    let bodyJson;
    const main = async () => {
      try {
        console.log(data);
    ...
    function consultaBD(query) {
      return new Promise(function (resolve, reject) {
        ...
        const db = registarCuentaFinanciera.dataSource;
